...
3. 탭 4개: **대시보드 / 업무관리 / 일정·공사등록 / 전화 및 기타메모**
4. 대시보드에는 현재 작성자와 관련된 업무·일정/공사·전화메모가 한 화면에 모아서 보입니다.
5. 업무관리에서 새 업무를 등록하면 요청자는 자동으로 현재 작성자가 되고, 담당자는 별도로 지정할 수 있습니다. 항목을 클릭하면 상세 이력을 보고 이어서 진행상황을 추가할 수 있습니다.
6. 일정·공사 등록 시 날짜는 "기간"과 "개별 날짜"를 함께 조합해서 추가할 수 있고, 숫자만 입력해도 자동으로 년-월-일 형식이 채워지며 팝업 달력에서 주말·공휴일(대한민국 법정 공휴일 기준)이 색으로 표시됩니다.
